    ...
    <div className="pt-32 pb-24 relative min-h-screen bg-zinc-950 overflow-hidden">
      ...
      <div className="container mx-auto px-6 max-w-7xl relative z-10">
        <SectionHeader
          ...
          badgeText="Reseller Partnership"
          title="Build Your Own"
          gradientTitle="Streaming Empire."
          description="Deploy the world's most reliable IPTV infrastructure under your own brand. We provide the technology; you capture the market."
        />
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-32">
          {benefits.map((b, i) => (
            <ScrollReveal key={i} delay={i * 0.1}>
              <motion.div 
                className="group bg-zinc-900/40 p-10 rounded-[2rem] border border-white/5 backdrop-blur-xl hover:border-brand-cyan/20 hover:bg-zinc-900/60 transition-all duration-500 h-full"
              >
                ...
                <div className="text-center mb-10">
                  ...
                  <div className="flex items-center justify-center gap-2 mb-4 bg-white/5 py-2 px-4 rounded-xl inline-flex mx-auto border border-white/5">
                     ...
                     <span className="text-brand-cyan font-black text-xs uppercase tracking-widest">
                       <AnimatedCounter to={pkg.credits as number} suffix=" Global Credits" />
                     </span>
                  </div>
